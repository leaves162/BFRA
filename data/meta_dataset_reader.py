...
from config import META_RECORDS_ROOT
...
from data.meta_dataset.data import dataset_spec as dataset_spec_lib
from data.meta_dataset.data import learning_spec
from data.meta_dataset.data import pipeline
from data.meta_dataset.data import config
...
class MetaDatasetReader(object):
    def __init__(self, mode, train_set, validation_set, test_set):
        ...
        self.test_set_dict = {}
        self.specs_dict = {}
        gin.parse_config_file(f"/sda1/st_data/code/TP_FDAS/data/meta_dataset_config.gin")
...
class MetaDatasetEpisodeReader(MetaDatasetReader):
    ...
    def __init__(self, mode, train_set=None, validation_set=None, test_set=None, test_type='standard'):
        ...
        if test_type == 'standard':
            if mode == 'train':
                ...
                print("train_episode_desscription:",train_episode_desscription)
    ...
    def _init_multi_source_dataset(self, items, split, episode_description):
        ...
        print('pipeline.make_multisource_episode_pipeline:')
    ...
    def get_test_task(self, session, item=None):
        #print('test_set_dict:',self.test_set_dict)
...
class MetaDatasetBatchReader(MetaDatasetReader):
    ...
    def _init_multi_source_dataset(self, items, split):
        ...
        multi_source_pipeline = pipeline.make_multisource_batch_pipeline(
            ...
            split=split, image_size=224, add_dataset_offset=True, shuffle_buffer_size=buffer_size)
